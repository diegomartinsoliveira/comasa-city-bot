...
module.exports = {
    bloquearComandosGrupo: async (usuarioComandos, idGrupo)=>{
        ...
        var categorias = ['figurinhas', 'utilidades', 'diversão'], primeiroComando = usuarioComandos[0]
    ...
    desbloquearComandosGrupo: async (usuarioComandos, idGrupo)=>{
        ...
        var categorias = ['todos', 'figurinhas', 'utilidades', 'diversão'], primeiroComando = usuarioComandos[0]
        if(categorias.includes(primeiroComando)){
            var comandosCategoria = []
            switch(primeiroComando){
                case "todos":
