...
const grupo = require('../comandos/grupo'), utilidades = require('../comandos/utilidades'), diversao = require('../comandos/diversao'), admin = require('../comandos/admin'), info = require('../comandos/info'), figurinhas = require('../comandos/figurinhas')
