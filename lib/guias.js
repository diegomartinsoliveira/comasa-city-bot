...
module.exports = {
    ...
    utilidade : {
        ...
        consultarcep: cabecalho+
        "Ex: *!consultarcep* XXXXXXXX - Exibe as informações do CEP que você digitou.",
        consultarferiado: cabecalho+
        "Ex: *!consultarferiado* [Ano] - Exibe os feriados do ano digitado.",
        consultarplaca: cabecalho+
        "Ex: *!consultarcnpj* XXXXXXXXXXXXXX - Exibe as informações do CNPJ que você digitou.",
        calc: cabecalho+
        ...
        clima: cabecalho+
        "Ex: *!clima* Joinville - Mostra o clima atual e dos próximos dias para Joinville.",
        ddd: cabecalho+
        "Ex: *!ddd* 47 - Exibe qual estado e região do DDD 47.\n\n"+
    ...
    grupo:{
        ...
        blista: cabecalho+
        "Ex: *!blista* +55479xxxx-xxxx - Adiciona o número digitado a lista negra do grupo.",
        dlista: cabecalho+
        "Ex: *!dlista* +55479xxxx-xxxx - Remove o número digitado da lista negra do grupo.",
        ...
        add: cabecalho+
        "Ex: *!add* 5547xxxxxxxxx - Digite o numero com o código do país para adicionar a pessoa.\n\n"+
        "Ex: *!add* 5547xxxxxxxxx, 5547xxxxxxxxx - Digite os numeros com o código do país (adiciona mais de uma pessoa no grupo).",
        rlink: cabecalho+
    ...
    diversao:{
        ...
        "Ex: *!roletarussa* - Sorteia um membro aleatório do grupo.\n\n"+
